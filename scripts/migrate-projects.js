...
import { loadAssetMapping, convertToRichText } from './migration-utils.js';
...
// Import projects data (we'll need to read it as CommonJS)
const projectsData = [
  {
    id: 1,
    ...
    shareableLink:
      'https://rotaract.rotaryzcwest.org/projects/regala-esperanza-3-in-1-project',
    ...
    gallery: [
      {
        ...
        caption:
          'PRIMAGRAVIDA Safe Motherhood initiative - Medical check-ups for first-time mothers',
        category: 'Health & Wellness',
      },
      {
        id: 2,
        ...
        caption:
          'MOA signing ceremony with Rotary Club, ZCMC, and Myler Agribusiness',
  ...
  },
  {
    ...
    slug: 'kids-fun-day',
    shortDescription:
      'A joyful event as part of the BACK TO SCHOOL initiative, featuring book turnover and Day Care Center improvement unveiling.',
    description:
      'The Rotaract Club of Zamboanga City West, successfully hosted a KIDS FUN DAY. This event was part of the BACK TO SCHOOL initiative, which included the turnover of books and the unveiling of a newly improved Day Care Center. The day was filled with excitement, learning, and unforgettable memories for all the students. We are committed to fostering a love for learning through fun and play, and this event was a fantastic step toward that goal.',
    richDescription:
      'The Rotaract Club of Zamboanga City West, successfully hosted a **KIDS FUN DAY**. This event was part of the **BACK TO SCHOOL** initiative, which included:\n\n• Turnover of books\n• Unveiling of a newly improved Day Care Center\n\nThe day was filled with excitement, learning, and unforgettable memories for all the students. We are committed to fostering a love for learning through fun and play, and this event was a fantastic step toward that goal.',
    date: '2024-08-31',
    venue: 'Barney Child Development Center, Brgy Tulungatung, Zamboanga City',
    impact:
      'Bringing smile and joy to young learners while fostering love for learning through fun and play',
    bulletPoints: [
      'Turnover of books',
      'Unveiling of a newly improved Day Care Center',
    ],
    ...
    gallery: [
      ...
      },
      {
        ...
        caption:
          'Book turnover and Day Care Center improvement unveiling ceremony',
        category: 'Education & Youth',
      },
    ],
  },
    ...
    gallery: [
      {
        ...
        caption:
          'International Coastal Cleanup 2024 - Community volunteers at R.T. Lim Boulevard',
        category: 'Environment',
      },
      {
        id: 2,
        ...
        caption:
          'Rotaract Club members participating in coastal cleanup activities',
        category: 'Environment',
      },
      {
        id: 3,
        ...
        caption:
          'Environmental awareness campaign with SK Federation and stakeholders',
        category: 'Environment',
      },
    ],
  },
    ...
    gallery: [
      {
        ...
        caption:
          'END POLIO Motorcade procession starting from Futura Condominium',
        category: 'Health & Wellness',
      },
      {
        id: 2,
        ...
        caption:
          'Community leaders and health advocates spreading polio awareness',
        category: 'Health & Wellness',
      },
      {
        id: 3,
        ...
        caption:
          'Rotaract Club supporting polio vaccination awareness campaign',
        category: 'Health & Wellness',
      },
    ],
  },
  {
    ...
    impact:
      "Together, we're planting the seeds of change and nurturing a future where no island is left behind in the journey toward food security and sustainability.",
    partners: [
      'Rotary Club of Zamboanga City West',
    ...
    gallery: [
      {
        ...
        caption:
          'Gardenator vertical farming system deployment in Sitio Bilang Bilang',
        category: 'Food Security',
      },
      {
        id: 2,
        ...
        caption:
          "D' Beat of Nutrition Project - Community food security initiative",
        category: 'Food Security',
      },
    ],
  },
  {
    ...
    partnerLinks: [
      {
        name: 'ROTARACT CLUB of MAKATI',
        url: 'https://www.facebook.com/RACMakatiPH',
      },
      { name: 'Kids Who Farm', url: 'https://www.facebook.com/kidswhofarm' },
      {
        name: 'Rotaract Club of Calumpit',
        url: 'https://www.facebook.com/raccalumpit3770',
      },
      {
        name: 'Rotaract Club of Carmen Valley',
        url: 'https://www.facebook.com/RotaractClubOfCarmenValley',
      },
      {
        name: 'Rotaract Club of Muntinlupa Central',
        url: 'https://www.facebook.com/RACMuntinlupaCentral',
      },
      {
        name: 'Rotaract Club of Lucena South',
        url: 'https://www.facebook.com/RotaractClubofLucenaSouth',
      },
      {
        name: 'Rotaract Club of San Pedro East 3820',
        url: 'https://www.facebook.com/RotaractSanPedroEast',
      },
    ],
    facebookLink: 'https://www.facebook.com/share/p/16UV2AtVgd/',
    shareableLink:
      'https://rotaract.rotaryzcwest.org/projects/bida-el-comunidad-year-2-muntinlupa',
    ...
    gallery: [
      {
        ...
        caption:
          'Multi-club collaboration - Rotaract Club of Makati and Zamboanga City West',
        category: 'Community Development',
      },
      {
        id: 2,
        ...
        caption:
          'Full-cycle technology transfer on vegetable production and composting',
        category: 'Community Development',
      },
    ],
  },
...
async function migrateProject(client, environment, project, assetMapping) {
  try {
    console.log(`📝 Migrating: ${project.title}`);

    // Get asset references
    const featuredImageId = assetMapping[project.image];
    const galleryAssetIds = project.gallery
      ? project.gallery.map(item => assetMapping[item.url]).filter(Boolean)
      : [];

    if (!featuredImageId) {
      console.warn(
        `⚠️  Featured image not found for ${project.title}: ${project.image}`
      );
    }
    ...
    const projectEntry = {
      fields: {
        ...
        shortDescription: { 'en-US': project.shortDescription },
        // Use plain description field since convertToRichText doesn't parse markdown
        // richDescription contains markdown syntax that would be displayed literally
        description: {
          'en-US': convertToRichText(project.description),
        },
        date: { 'en-US': project.date },
        venue: { 'en-US': project.venue },
        impact: { 'en-US': project.impact },
        partners: { 'en-US': project.partners || [] },
        facebookLink: { 'en-US': project.facebookLink },
        shareableLink: { 'en-US': project.shareableLink },
        category: { 'en-US': project.category },
        hashtags: { 'en-US': project.hashtags || [] },
        highlights: { 'en-US': project.highlights || [] },
      },
    };

    // Add optional fields
    if (project.bulletPoints) {
      projectEntry.fields.bulletPoints = { 'en-US': project.bulletPoints };
    }

    if (project.partnerLinks) {
      projectEntry.fields.partnerLinks = { 'en-US': project.partnerLinks };
    }

    // Add featured image if available
    if (featuredImageId) {
      projectEntry.fields.featuredImage = {
        'en-US': {
          sys: {
            type: 'Link',
            linkType: 'Asset',
    ...
    if (galleryAssetIds.length > 0) {
      projectEntry.fields.gallery = {
        'en-US': galleryAssetIds.map(assetId => ({
          sys: {
            type: 'Link',
            linkType: 'Asset',
            id: assetId,
    ...
    try {
      ...
      console.warn(
        `⚠️  Could not check for existing project "${project.title}":`,
        error.message
      );
    }

    // Create and publish entry
    const entry = await environment.createEntry('project', projectEntry);
    await entry.publish();

    console.log(`✅ Migrated: ${project.title} (ID: ${entry.sys.id})`);
...
async function migrateProjects() {
  try {
    ...
    console.log(`\n📋 Found ${projectsData.length} projects to migrate\n`);
