...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Rotaract Club of Zamboanga City West - Fellowship, Service &
          Leadership Since 2010
        </title>
        <meta
          name="title"
          content="Rotaract Club of Zamboanga City West - Fellowship, Service & Leadership Since 2010"
        />
        <meta
          name="description"
          content="Join the Great West movement! Empowering young Zamboangueño leaders through fellowship, community service, and professional development. Discover our award-winning projects and become part of a dynamic community making lasting impact in Zamboanga City."
        />
        <meta
          name="keywords"
          content="Rotaract Zamboanga City West, young leaders Philippines, community service Zamboanga, fellowship programs, leadership development, Rotary International, Great West, volunteer opportunities, youth organization Philippines, Rotaract club activities"
        />
        ...
        <meta
          ...
          content="Rotaract Club of Zamboanga City West - Young leaders making impact"
        />
        <meta
        ...
        <meta
          ...
          content="https://rotaract.rotaryzcwest.org/"
        />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            foundingDate: '2010',
            description:
              'Empowering young Zamboangueño leaders through fellowship, community service, and professional development since 2010. Part of the Great West movement creating lasting impact in Zamboanga City.',
            memberOf: {
              '@type': 'Organization',
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  itemOffered: {
                    ...
                    description:
                      'Award-winning community service projects and initiatives',
                  },
                },
                {
                  '@type': 'Offer',
                  itemOffered: {
                    ...
                    description:
                      'Building lasting friendships and connections among young leaders',
                  },
                },
              ],
            },
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            url: 'https://rotaract.rotaryzcwest.org',
            description:
              'Official website of the Rotaract Club of Zamboanga City West - empowering young leaders through fellowship, service, and leadership since 2010.',
            publisher: {
              '@type': 'Organization',
              name: 'Rotaract Club of Zamboanga City West',
            },
