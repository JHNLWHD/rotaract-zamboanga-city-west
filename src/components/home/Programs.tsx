  ...
  const areasOfFocus = [
    {
      ...
      description:
        'Promoting understanding and building capacity to resolve conflicts and create lasting peace in communities.',
      color: 'blue',
      highlights: [
    ...
    },
    {
      ...
      description:
        'Improving access to healthcare and preventing the spread of life-threatening diseases in our communities.',
      color: 'cranberry',
      highlights: [
        'Health Screenings',
    ...
    },
    {
      ...
      description:
        'Ensuring access to clean water and promoting proper sanitation practices for healthier communities.',
      color: 'teal',
      highlights: [
    ...
    },
    {
      ...
      description:
        'Supporting mothers and children through healthcare programs and nutrition initiatives.',
      color: 'purple',
      highlights: [
        'Prenatal Care',
        'Nutrition Programs',
    ...
    },
    {
      ...
      description:
        'Strengthening educational systems and promoting literacy to empower communities through knowledge.',
      color: 'orange',
      highlights: [
        'Literacy Programs',
        'School Support',
    ...
    },
    {
      ...
      description:
        'Creating opportunities for economic growth and sustainable community development initiatives.',
      color: 'green',
      highlights: [
    ...
    },
    {
      ...
      title: 'Environment',
      description:
        'Protecting our planet through environmental conservation and sustainability projects.',
      color: 'emerald',
      highlights: [
      ...
      <div className="relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto reveal-on-scroll leading-relaxed">
            Through Rotary's seven areas of focus, we address the world's most
            persistent challenges and create sustainable solutions in our
            community.
          </p>
        </div>
              ...
              >
                <div className="p-8">
                  <div className="flex items-start justify-between mb-6">
                    <div
                      className={`p-4 ${colorClasses.iconBg} rounded-2xl group-hover:scale-110 transition-transform duration-300`}
                    >
                      <img
                        src={area.icon}
                        alt={`${area.title} icon`}
                  ...
                  <div className="space-y-4">
                    <h3
                      className={`text-card-title ${colorClasses.accent} group-hover:text-slate-900 transition-colors`}
                    >
                      {area.title}
                    </h3>
                    ...
                    <div className="space-y-2">
                      {area.highlights.map((highlight, idx) => (
                        <div key={idx} className="flex items-center space-x-2">
                          <div
                            className={`w-1.5 h-1.5 ${colorClasses.iconBg} rounded-full`}
                          ></div>
                  ...
                  <div
                    className={`mt-6 h-1 ${colorClasses.iconBg} rounded-full opacity-50 group-hover:opacity-100 transition-opacity`}
                  ></div>
                </div>
              </article>
            );
        ...
        <div className="text-center mt-20 reveal-on-scroll">
          <div className="modern-card p-12 max-w-4xl mx-auto bg-gradient-to-r from-cranberry-600 to-cranberry-500 text-white rounded-3xl">
            <h3 className="text-3xl font-bold text-white mb-6">
              Ready to Make a{' '}
              <span className="text-cranberry-100">Difference</span>?
            </h3>
            <p className="text-cranberry-100 text-lg mb-8 max-w-2xl mx-auto">
              Join us in our mission to create positive change. Whether you're
              interested in community service, professional development, or
              global citizenship, there's a place for you.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="#join"
                className="bg-white text-cranberry-600 px-8 py-4 rounded-full font-semibold hover:bg-gray-50 transition-colors shadow-lg hover:shadow-xl"
              >
