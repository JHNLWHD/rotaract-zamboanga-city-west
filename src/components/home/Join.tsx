...
const Join = () => {
  ...
  useEffect(() => {
    ...
    if (currentProcessRef) {
      observer.observe(currentProcessRef);
    }
    ...
    return () => {
      ...
      if (currentProcessRef) {
        observer.unobserve(currentProcessRef);
      }
    };
  }, []);
  ...
  const membershipLevels = [
    ...
    },
    {
      ...
      description:
        'Deeper involvement through advocacy and continued commitment',
    },
    {
      ...
      description:
        'Reward for significant contributions and embodying organizational values',
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        'Build essential leadership skills through hands-on experience',
    },
    {
      ...
      <div className="relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-section-title text-slate-900 reveal-on-scroll mb-6">
            ...
            <br />
            Journey with the <span className="text-gradient">Great West</span>
          </h2>

          <p className="text-xl text-slate-600 max-w-3xl mx-auto reveal-on-scroll leading-relaxed">
            Become part of a dynamic community of young leaders committed to
            making a positive impact in Zamboanga City and beyond.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-20">
          ...
          <div className="reveal-on-scroll">
            <h3 className="text-2xl font-bold text-slate-900 mb-8">
              Your Journey to{' '}
              <span className="text-cranberry-600">Membership</span>
            </h3>
